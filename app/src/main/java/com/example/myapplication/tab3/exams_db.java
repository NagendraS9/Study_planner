...
public class exams_db extends SQLiteOpenHelper {
    static final private String DB_NAME="EXAMS_PLAN";
    static final private String DB_TABLE="EXAMS";
    static final private int DB_Version=1;

    Context ctx;
    SQLiteDatabase my_DB;
    public exams_db(@Nullable Context context) {
...
//            String s3= (String) DateFormat.format("hh:mm aa",cal2);
            arrPlans.add(new exams_model(id,title,desc,cal));
        }
        my_DB.close();
        return arrPlans;
    }
