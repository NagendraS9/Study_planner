 ...
 * Use the {@link fourth_tab#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fourth_tab extends Fragment {

    lectures_db myDB;
    lecturesViewAdapter myadapter;
    ...
    public static fourth_tab newInstance(String param1, String param2) {
        fourth_tab fragment = new fourth_tab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myDB=new lectures_db(getActivity());
...
//                Toast.makeText(getActivity(),"clicked item index is " + Integer.toString(index),Toast.LENGTH_LONG).show();
                ...
                lectures_model obj=(lectures_model) arrPlans.get(index);
        ...
        myadapter=new lecturesViewAdapter(arrPlans,getContext(),listener);
