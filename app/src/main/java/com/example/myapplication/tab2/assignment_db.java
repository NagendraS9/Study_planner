...
public class assignment_db extends SQLiteOpenHelper {
    static final private String DB_NAME="ASSIGNMENT_PLANS";
    static final private String DB_TABLE="ASSIGNMENT";
    static final private int DB_Version=1;

    Context ctx;
    SQLiteDatabase my_DB;
    public assignment_db(@Nullable Context context) {
...
//            String s3= (String) DateFormat.format("hh:mm aa",cal2);
            arrPlans.add(new Assignment_model(id,title,desc,cal));
        }
        my_DB.close();
        return arrPlans;
    }
